...
Raw AFL data is sourced from Fryzigg data feed.
Links team performance trends to individual player output over a 3-5 game window using pure Fryzigg statistics (e.g., Clearances, Contested Possessions, Inside 50s, Score Involvements). Explicitly excludes AFL Fantasy or Supercoach points.
